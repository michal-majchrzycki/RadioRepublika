...
class FridayViewController: UIViewController, NSXMLParserDelegate
{
    ...
    {
        posts = []
        parser = NSXMLParser(contentsOfURL:(NSURL(string:"https://dl.dropboxusercontent.com/s/3vujp9gompwi7sa/piatek.rss"))!)!
