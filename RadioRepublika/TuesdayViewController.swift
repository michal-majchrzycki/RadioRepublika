...
class TuesdayViewController: UIViewController, NSXMLParserDelegate
{
    ...
    {
        posts = []
        parser = NSXMLParser(contentsOfURL:(NSURL(string:"https://dl.dropboxusercontent.com/s/0om3efefa8aidj4/wtorek.rss"))!)!
