...
class SundayViewController: UIViewController, NSXMLParserDelegate
{
    ...
    {
        posts = []
        parser = NSXMLParser(contentsOfURL:(NSURL(string:"https://dl.dropboxusercontent.com/s/9dnzho5t2zebq2b/niedziela.rss"))!)!
