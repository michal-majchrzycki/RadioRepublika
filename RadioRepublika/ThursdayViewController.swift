...
class ThursdayViewController: UIViewController, NSXMLParserDelegate
{
    ...
    {
        posts = []
        parser = NSXMLParser(contentsOfURL:(NSURL(string:"https://dl.dropboxusercontent.com/s/xzl1bx0z58q33aq/czwartek.rss"))!)!
