...
class WednesdayViewController: UIViewController, NSXMLParserDelegate
{
    ...
    {
        posts = []
        parser = NSXMLParser(contentsOfURL:(NSURL(string:"https://dl.dropboxusercontent.com/s/f9voh3h78t9oi05/sroda.rss"))!)!
